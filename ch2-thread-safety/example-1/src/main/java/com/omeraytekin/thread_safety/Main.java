...
import com.omeraytekin.thread_safety.servlets.CachedFactorizer;
...
public class Main {
    public static void main(String[] args) throws LifecycleException {
        ...
        GenericServlet servletCachF = new CachedFactorizer();
        ...
        String servletNameCachF = "CachedFactorizer";
        ...
        String urlPatternCachF = "/cached-factorizer";
        ...
        tomcat.addServlet(contextPath, servletNameCachF, servletCachF);
        ...
        context.addServletMappingDecoded(urlPatternCachF, servletNameCachF);
        tomcat.start();
